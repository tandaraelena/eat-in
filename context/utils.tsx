...
export const products = [
    ...
    },
    {
      ...
      price: 23,
      kcal: '433 kcal',
      description: 'A bowl of soup made from chicken, carrot, parsley, parsnips, garlic, sour cream and celery root.',
      dietary: {
    ...
    },
    {
      ...
      price: 21,
      kcal: '230 kcal',
      description: 'A bowl of soup made from a mix of vegetables and tasty meatballs.',
      dietary: {
    ...
    },
    {
      ...
      price: 20,
      kcal: '333 kcal',
      description: 'A flavoured bowl of boiled chicken breast seasoned with onions,carrots, celery root and tiny rolls of pastas.',
      dietary: {
